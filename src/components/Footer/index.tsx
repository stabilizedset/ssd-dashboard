        ...
        <div style={{maxWidth: '1100px', marginLeft: 'auto', marginRight: 'auto'}}>
          <div style={{ padding: '2%', display: 'flex'}}>
            <div style={{ width: '50%', textAlign: 'left' }}>
              ...
              <FooterLink icon={<i className="fab fa-telegram"/>} href={"https://www.t.me/stabilizedset"}/>
            </div>
            <div style={{ width: '45%', textAlign: 'right', height: '18px', marginTop: '15px', marginBottom: '15px'}}>
              made with <span role="img" aria-labelledby="heartbreak">❤️</span> by SSD Team based on the work of &#123;ess&#125;.
            </div>
