...
function RemoveLiquidity({
  ...
  const estimatedSSDReceived = pairBalanceSSD.times(poolPortion);

  const minUSDCReceived = decreaseWithSlippage(estimatedUSDCReceived);
  const minSSDReceived = decreaseWithSlippage(estimatedSSDReceived);
          ...
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ width: '35%', marginRight: '5%' }}>
              <>
                ...
                <PriceSection label="+ " amt={estimatedSSDReceived} symbol=" SSD" />
              </>
            </div>
            <div style={{ width: '30%' }}>
              <Button
                ...
                onClick={() => {
                  removeLiquidity(
                    ...
                    toBaseUnitBN(minSSDReceived, SSD.decimals),
